...
export default () => {
  ...
  registerForm.addEventListener("submit", e => {
    e.preventDefault();
    const username = document.querySelector("#register-form input[type=text]")
      .value;
    const password = document.querySelector(
      "#register-form input[type=password]"
    ).value;

    axios.post("/users/register", { username, password }).then(({ data }) => {
      if (data.success) {
  ...
  signinForm.addEventListener("submit", e => {
    e.preventDefault();
    const username = document.querySelector("#signin-form input[type=text]")
      .value;
    const password = document.querySelector("#signin-form input[type=password]")
      .value;
