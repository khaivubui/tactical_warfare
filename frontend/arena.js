...
export default class Arena {
  constructor(
    ...
    this.ground.mesh.material.diffuseTexture = new BABYLON.Texture(
      scene.groundTask,
      scene
    );
    ...
    this._sidewall0.material.diffuseTexture = new BABYLON.Texture(
      scene.sideWallTask,
      scene
    );
    this._sidewall1.material.diffuseTexture = new BABYLON.Texture(
      scene.sideWallTask,
      scene
    );
    this._sidewall2.material.diffuseTexture = new BABYLON.Texture(
      scene.sideWallTask,
      scene
    );
    this._sidewall3.material.diffuseTexture = new BABYLON.Texture(
      scene.sideWallTask,
      scene
    );
    ...
    this._ceiling.material.diffuseTexture = new BABYLON.Texture(
      scene.ceilingTask,
      scene
    );
